  ...
  <div class="bg-dark-700/50 rounded-xl p-4 border border-white/5 hover:border-primary-500/30 transition-all group">
    <div class="flex items-start justify-between">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h4 class="font-semibold text-white group-hover:text-cyan-300 transition-colors">
            {{ asset.name }}
          </h4>
          <p class="text-sm text-gray-500">
            {{ asset.symbol || 'MF' }} • {{ asset.quantity }} units
          </p>
        </div>
      </div>
